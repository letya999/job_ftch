...
- [Source Coverage Matrix](coverage_matrix.md) - Operational guidance for the heavy career-site boards that were the main (Updated: 2026-07-27)
...
- [Search query ingest](search_query_ingest.md) - How career-site source URLs are expanded into keyword-search ingest targets. (Updated: 2026-07-30)
- [Source Setup](setup.md) - Prefer declarative source setup through `SourceSpec` entries inside a tenant YAML file. (Updated: 2026-07-28)
