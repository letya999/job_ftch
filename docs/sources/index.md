...
- [CAPTCHA provider rollout](captcha_provider_rollout.md) - Operational rollout for observed CAPTCHA/bot-protection handling: project wiring, browser setup, provider roles, and eval gates. (Updated: 2026-09-17)
