...
- [Bypass и escalation path](bypass_and_escalation.md) - Adaptive bypass для ingest: failure signals, route axes, proxy/session/challenge boundaries и запреты. (Updated: 2026-09-13)
- [CAPTCHA provider rollout](captcha_provider_rollout.md) - Operational rollout for observed CAPTCHA/bot-protection handling: project wiring, browser setup, provider roles, and eval gates. (Updated: 2026-09-13)
- [Career-site runtime flow](career_site_runtime.md) - Фактический control-flow CareerSiteSource.fetch(): strategy init, site parser, generic search, monitor chain, discover/enrich, freshness, zero-yield taxonomy и teardown. (Updated: 2026-09-01)
...
- [Search query ingest](search_query_ingest.md) - How career-site source URLs are expanded into keyword-search ingest targets. (Updated: 2026-09-03)
...
- [Source assessment](source_assessment.md) - Pre-ingest оценка источников: capability hints, freshness evidence, probe outcomes и границы ответственности. (Updated: 2026-09-01)
