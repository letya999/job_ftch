...
- [MCP adapter](mcp_adapter.md) - FastMCP tenant server exposing pipeline tools and job resources. (Updated: 2026-08-19)
- [MCP client setup](mcp_client_setup.md) - How to point local MCP clients at the job_ftch tenant server. (Updated: 2026-08-18)
