...
from job_ftch.domain import FilterProfile, Job, JobValidationRejectionReason
...
class AIRoleRelevanceNode:
    ...
    async def process(self, item: Job) -> Job | None:
        ...
        from job_ftch.domain import PostType  # avoid circular at module level, use local import
