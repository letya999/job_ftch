...
class CareerSiteSpec(BaseSourceSpec):
    ...
    monitor_config: dict[str, object] = Field(default_factory=dict)  # passed to monitor
    scraper: str | None = None  # registered scraper name; None = auto from monitor
    scraper_config: dict[str, object] = Field(default_factory=dict)  # passed to scraper
    ...
    url_filter: str | dict[str, str] | None = None  # regex or {include, exclude}
    url_transform: dict[str, str] | None = None  # {find, replace} regex rewrite
