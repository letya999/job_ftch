...
class FilterProfile(BaseModel):
    ...
    def default(cls) -> FilterProfile:
        ...
        # positive_relevance_keywords mirrors _POSITIVE_KEYWORDS from job_ftch.nodes/relevance.py
        # negative_relevance_keywords mirrors _NEGATIVE_KEYWORDS from job_ftch.nodes/relevance.py
        # exclude_keywords mirrors _IRRELEVANT_PATTERNS from job_ftch.nodes/triage.py
