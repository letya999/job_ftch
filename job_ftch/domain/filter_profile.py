...
class FilterProfile(BaseModel):
    ...
    def default(cls) -> FilterProfile:
        return cls(
            name="default",
            profile_description=(
                "AI and ML engineering roles including LLM, NLP, computer vision, "
                "MLOps, data science, AI platform, and AI product roles."
            ),
            target_roles=[
                "ai engineer",
                "llm engineer",
            ...
            preferred_skills=["python", "pytorch", "transformers", "rag", "kubernetes"],
