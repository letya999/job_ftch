...
# Pinned commit SHAs per model. Lookup: huggingface.co/<model>/commits/main → copy the latest SHA.
...
class CTranslate2Translator:
    ...
    async def translate(self, text: str, source_lang: str, target_lang: str) -> str:
        ...
        try:
            ...
            logger.warning(
                "translation_failed", source=source_lang, target=target_lang, error=str(exc)
            )
