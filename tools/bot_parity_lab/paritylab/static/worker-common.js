...
self.collectParityWorkerProbe = async function collectParityWorkerProbe() {
  ...
  let errorStack = "";
  try { throw new Error("worker-stack-probe"); }
  ...
  return normalize({
    ...
    capabilities: {
      ...
      eventSource: typeof self.EventSource,
