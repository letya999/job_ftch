...
from job_ftch.infrastructure.source_validation import check_url_reachable, validate_sources
...
async def test_validate_sources_mixed():
    ...
    with patch(
        "job_ftch.infrastructure.source_validation.check_url_reachable", side_effect=mock_reachable
    ):
