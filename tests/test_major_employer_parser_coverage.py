...
MAJOR_EMPLOYER_SITES = (
    ...
    ("Cloud.ru", "https://cloud.ru/career/vacancies"),
    ("Just AI", "https://careers.just-ai.com/"),
    ...
    ("Halyk Bank career", "https://halykbank.kz/career"),
    ...
    ("T2", "https://careers.t2.ru/"),
    ("rabota.kz", "https://rabota.kz/"),
    ("BCC", "https://www.bcc.kz/career/vacancies/"),
    ("inDrive", "https://careers.indrive.com/vacancies/"),
    ("GorodRabot KZ", "https://kazahstan.gorodrabot.kz/"),
    ("Higgsfield", "https://careers.higgsfield.kz/"),
