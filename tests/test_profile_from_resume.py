...
def test_add_example_to_profile():
    ...
    assert example2 in managed3.profile.search_profiles[0].negative_example_texts
    assert example1 in managed3.profile.search_profiles[0].positive_example_texts
