import pytest
from job_ftch.domain import JobDraft, JobRecord, SkillTag, SourceKind, Seniority
from job_ftch.infrastructure.ontology.normalizer import OntologyNormalizer
from job_ftch.nodes.job_normalization import TitleCompanyNormalizationNode, SkillNormalizationNode
