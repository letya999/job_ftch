...
class SentenceTransformersProvider(EmbeddingProvider):
    def __init__(self, settings: Settings) -> None:
        if SentenceTransformer is None:
            raise ImportError("sentence-transformers is not installed. Install it with: pip install sentence-transformers torch")
        ...
        self._dimensions = settings.embedding_dimensions or self._model.get_sentence_embedding_dimension()
